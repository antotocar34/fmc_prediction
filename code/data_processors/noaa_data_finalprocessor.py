...
socc = socc.drop(["GACC", "State", "Group", "Zip"], axis=1)
...
socc.insert(2, "AccSpeciesID", species_ids) #Add species IDs
#%%
...
#%%
feature_interactions = [feature for feature in socc.columns if feature not in ["Date", "Site", "Fuel", "Percent"]]
