...
lmerRE_formula <- get_formula(train, fix_ef=all_vars, ran_ef=ran_ef, type="lmer_RE") #Altered for BMS
...
```
```{r}
predictions <- list(olspooledpred, olsunpooledpred, lmerrepred, lmerre3pred)
colors <- c("green", "orange", "turquoise2", "purple")
grid <- plot_grid_pred(predictions, test, "sage, black", modelnames, colors)
```
...
stargazer(lmer.fitre, out=paste0("analysis/results/", modeltype, "/lmer_pcaall_", modeltype, ".tex"))
class(lmer.fitre_2) <- "lmerMod"
stargazer(lmer.fitre_2, out=paste0("analysis/results/", modeltype, "/lmer_pca6_", modeltype, ".tex"))
class(lmer.fitre_3) <- "lmerMod"
stargazer(lmer.fitre_3, out=paste0("analysis/results/", modeltype, "/lmer_pcamin_", modeltype, ".tex"))
stargazer(all_results, out=paste0("analysis/results/", modeltype, "/r2_results_", modeltype, ".tex"))
```
